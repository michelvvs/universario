...
export const THEME_HEAD_ALIGNMENTS: Record<GenderKey, Record<StoryTheme, HeadAlignment>> = {
  boy: {
    ...
    news: { top: '-29%', left: '51%', width: '74%' },
    cinema: { top: '-18%', left: '40%', width: '65%' },
    stats: { top: '-23%', left: '50%', width: '56%' },
    summary: { top: '-15%', left: '40%', width: '72%' },
  },
  girl: {
    intro: { top: '-30%', left: '50%', width: '57%' },
    moon: { top: '-25%', left: '50%', width: '65%' },
    radio: { top: '-22%', left: '52%', width: '65%' },
    sales: { top: '-25%', left: '50%', width: '65%' },
    billboard: { top: '-22%', left: '49%', width: '62%' },
    news: { top: '-20%', left: '50%', width: '70%' },
    cinema: { top: '-26%', left: '50%', width: '66%' },
